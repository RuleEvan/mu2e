...
double compute_matrix_element_sigma_0_finite_q_op6(int in1p, int ij1p, int in2p, int ij2p, int ij12p, int in1, int ij1, int in2, int ij2, int ij12, double qt, int J1, int J2, int J, int t12);
double compute_matrix_element_sigma_0_finite_q_op7(int in1p, int ij1p, int in2p, int ij2p, int ij12p, int in1, int ij1, int in2, int ij2, int ij12, double qt, int J1, int J2, int J, int t12);
...
double compute_total_matrix_element_sigma_0_finite_q_op6(char *density_file, double qt, int J1, int J2, int J);
double compute_total_matrix_element_sigma_0_finite_q_op7(char *density_file, double qt, int J1, int J2, int J);
