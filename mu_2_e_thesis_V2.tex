...
In Chapter \ref{chap:coherent_conversion}, we explicitly construct the tower of effective theories for the special case of coherent $\mu\rightarrow e$ conversion mediated by a heavy scalar particle. We demonstrate how CLFV branching ratios can be computed with controlled uncertainties, allowing one to exclude candidate UV models. We apply this formalism to Higgs-mediated CLFV.
