...
W^{\tau\tau'}_{O\Sigma^{'(i)}}(q_\mathrm{eff})&\equiv \frac{4\pi}{2j_N+1}\sum_{J=1,3,...}^{\infty}\braket{j_N||O_{J;\tau}(q_\mathrm{eff})||j_N}\braket{j_N||\Sigma^{'(i)}_{J;\tau'}(q_\mathrm{eff})||j_N}\;\mathrm{for}\;O=\Delta,\Sigma',\\
&\hspace*{10.5cm}\mathrm{and}\;i=0,2\\
...
&+\hat{r}\cdot\vec{\sigma}(i)\;\hat{r}\cdot\vec{\sigma}(j)\;j_0(qR_{ij})F^{(1)}(qr_{ij}/2)-\big[\hat{r}_{ij}\times\hat{R}_{ij}\big]\cdot\big[\vec{\sigma}(i)\times\vec{\sigma}(j)\big]\;j_1(qR_{ij})F^{(2)}(qr_{ij}/2)\Bigg\}\vec{\tau}(i)\cdot\vec{\tau}(j).
\end{split}
\end{equation}
...
W_{\Delta'\Sigma}^{\tau\tau'}(q_\mathrm{eff})&\equiv \frac{4\pi}{2j_i+1} \sum_{J=2,4,...}^{\infty}\braket{j_f||\Delta'_{J;\tau}(q_\mathrm{eff})||j_i}\braket{j_f||\Sigma_{J;\tau'}(q_\mathrm{eff})||j_i}\tag{\refstepcounter{equation}\theequation}\\
...
W_{\Delta'\Sigma}^{\tau\tau'}(q_\mathrm{eff})&\equiv \frac{4\pi}{2j_i+1} \sum_{J=1,3,...}^{\infty}\braket{j_f||\Delta'_{J;\tau}(q_\mathrm{eff})||j_i}\braket{j_f||\Sigma_{J;\tau'}(q_\mathrm{eff})||j_i}\tag{\refstepcounter{equation}\theequation}\\
