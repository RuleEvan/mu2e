...
R_{\Phi''M}^{\tau\tau'}&\equiv c_3^{\tau}c_1^{\tau'}-(c_{12}^{\tau}-c_{15}^{\tau})c_{11}^{\tau'}\\
R_{\Delta'\Sigma}^{\tau\tau'}=R_{\Delta\Sigma'}^{\tau\tau'}&\equiv c_5^{\tau}c_4^{\tau'}+c_8^{\tau}c_9^{\tau'}.\\
\end{split}
\end{equation}
...
\begin{equation}
\begin{split}
R_{\tilde{\Delta}''M}^{\tau\tau'}&\equiv\mathrm{Im}\left[-c_2^{\tau}c_1^{\tau'}+(c_8^{\tau}-c_{16}^{\tau})c_{11}^{\tau'}\right]=0\\
R_{\Phi''\tilde{\Delta}''}^{\tau\tau'}&\equiv\mathrm{Im}\left[-c_3^{\tau}c_2^{\tau'}-(c_{12}^{\tau}-c_{15}^{\tau})(c_8^{\tau'}-c_{16}^{\tau'})\right]=0\\
R_{\Sigma''\tilde{\Omega}}^{\tau\tau'}&\equiv\mathrm{Im}\left[(c_4^{\tau}-c_6^{\tau})c_{14}^{\tau'}-c_{10}^{\tau}c_7^{\tau'}\right]=0\\
R_{\Delta\tilde{\Phi}}^{\tau\tau'}=R_{\Delta'\tilde{\Phi}'}^{\tau\tau'}&\equiv\mathrm{Im}\left[-\left(c_5^{\tau}c_{13}^{\tau'}+c_8^{\tau}c_{12}^{\tau'}\right)\right]=0\\
R_{\Sigma'\tilde{\Phi}}^{\tau\tau'}=R_{\Sigma\tilde{\Phi}'}^{\tau\tau'}&\equiv\mathrm{Im}\left[-\left(c_4^{\tau}c_{13}^{\tau'}+c_9^{\tau}c_{12}^{\tau'}\right)\right]=0.
\end{split}
\end{equation}
