...
\end{equation}
that is fully dictated by velocity-suppression. To an extent, this picture is altered in heavier nuclei, where the excess of neutrons restores some of the coherence from the $M_{00;1}$ and $\tilde{\Phi}''_{00;1}$ responses. This effect is readily observed in Figure \ref{fig:Cu_responses} in the case of Cu.
\begin{figure}
\centering
